        ...
        <div class="container">
            ...
            <!-- Heading -->
                <div class="row">
                    ...
                    <div class="col">
                        <h2 class="mb-5 font-weight-bold">Administrar horario</h2>
                    </div>
                    <div class="col">
                    </div>
                ...
                <form action="?controller=admin&accion=buscarHorario" method="POST">
                                ...
                                <?php foreach ($horario as $d) : ?>
                                    ...
                                    <tr>  
                                        ...
                                        if($d["dia"] == 'Lunes'){
                                            echo $d["nombre"];
                                            ?>
                                            <a href="?controller=admin&accion=deltramo&id=<?= $d['id'] ?>"><i class="fas fa-minus-square"></i></i> </a>
                                            <?php
                                        }
                                         ?></td>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="row">
                                    ...
                                    <div class="col">
                                    <h3 class="mb-5 font-weight-bold">Añadir nuevo tramo</h3>
                                    </div>
                                    <div class="col">
                                    </div>
                                </div>
                                ...
                                <?php
                                    if(isset($tramo)){
                                    ?>
                                        <form action="?controller=admin&accion=acttramo&id=<?= $usuario['id'] ?>" method="POST" enctype="multipart/form-data">
                                    <?php

                                    }else{
                                    ?>
                                        <form action="?controller=admin&accion=addtramo" method="POST" enctype="multipart/form-data">
                                    <?php
                                    }
                                ?>
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <div class="input-group form-group">
                                            <label for="nombre" class="remember">Hora inicio </label>
                                            
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="input-group form-group">
                                        <select class="browser-default custom-select mb-4" name="hora_inicio">

                                        <?php
                                            $fecha = date("Y-m-d");
                                            $timestamp = strtotime($fecha.' 09:00:00')-900;
                                            $timestamp_limite = strtotime($fecha.' 17:29:59');
                                    ...
                                    <div class="col-2">
                                        <div class="input-group form-group">
                                        <label for="apellidos" class="remember">Hora fin</label>
                                            
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="input-group form-group">
                                        <select class="browser-default custom-select mb-4" name="hora_fin">

                                            
                                            <?php
                                            $fecha = date("Y-m-d");
                                            $timestamp = strtotime($fecha.' 09:30:00')-900;
                                            $timestamp_limite = strtotime($fecha.' 17:59:59');
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <div class="input-group form-group">
                                        <label for="nombre" class="remember">Actividad </label>
                                    ...
                                    <div class="col-3">
                                        ...
                                        <select class="browser-default custom-select mb-4" name="id_actividad">
                                    ...
                                    <div class="col-2">
                                        <div class="input-group form-group">
                                        <label for="nombre" class="remember">Dia </label>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <select class="browser-default custom-select mb-4" name="dia">

                                            <option value="" disabled selected>Elige dia</option>
