    ...
    <main class="mt-5">
        <div class="container">
            ...
            <section id="best-features" class="text-center">
                ...
                <!-- Heading -->
                <h2 class="mb-5 font-weight-bold">Horario</h2>
                <h6 class="mb-5 font-weight-bold">Fecha del horario desde el Lunes (<?php echo date("d/m/y",strtotime( "Monday this week" )); ?>) hasta el Sabado (<?php echo date("d/m/y",strtotime( "next sunday" )); ?>)</h4>
            ...
            <section id="examples" class="text-center">
                ...
                <!-- Heading -->
                <h2 class="mb-5 font-weight-bold">Nuevos deportes</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12 mb-4">
                        ...
                        <div class="view overlay z-depth-1-half">
                            <img src="images/foto1.jpg" class="img-fluid" alt="">
                            <div class="mask rgba-white-slight"></div>
                        </div>

                        <h4 class="my-4 font-weight-bold">Boxeo</h4>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <h4 class="my-4 font-weight-bold">Capoeira</h4>
                        <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit
                            maiores nam,
                            aperiam minima
                            assumenda deleniti hic.</p>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <div class="view overlay z-depth-1-half">
                            <img src="images/foto3.jpg" class="img-fluid" alt="">
                            <div class="mask rgba-white-slight"></div>
                        </div>

                        <h4 class="my-4 font-weight-bold">Kickboxing</h4>
                        <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit
                            maiores nam,
                            aperiam minima
                            assumenda deleniti hic.</p>
